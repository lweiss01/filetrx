...
5. Run `holistic start --agent antigravity` to register the session.

**After significant work or any git commit (hook fires automatically):**
- Run `holistic checkpoint --reason '<what you just did>'`

**At the end of every session:**
- Run `holistic handoff` — this opens a dialog to capture the summary.
- Then commit: `git add HOLISTIC.md AGENTS.md HISTORY.md .holistic/ && git commit -m 'docs(holistic): handoff'`
